...
export default function Navbar() {
  return (
    <nav className="w-[90%] mx-auto bg-[#7A1523] h-10 py-6 rounded-full flex items-center justify-between shadow-lg">
      <div className="flex space-x-14 text-white text-lg font-medium">
        ...
        <Link
          to="/cart"
          className="flex items-center space-x-2 text-white text-2xl hover:text-gray-300"
        >
